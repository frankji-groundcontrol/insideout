...
| P1 | [Roadmap parity + GitHub-driven progress](2026-08-21-roadmap-parity-and-github.md) | **In flight** | Install the GitHub App (user) and confirm one real delivery. | Evidence loop live end-to-end: guide-matched pushes land idempotent leaf evidence ([changelog](../changelogs/2026-08-21-evidence-loop.md)). |
