...
| P1 | [CLI / MCP parity (one truth, many views)](2026-08-21-cli-mcp-parity.md) | **In flight** | Stage 2: MCP server with tools 1:1 to the CLI verbs (extend the frozen list with the roadmap verbs). | CLI read surface live and verified against the hosted API ([changelog](../changelogs/2026-08-21-cli-read-parity.md)). |
| P1 | [Roadmap parity + GitHub-driven progress](2026-08-21-roadmap-parity-and-github.md) | **In flight** | Install the GitHub App on the repo (user), then matching guide + installation tokens. | Webhook live 2026-08-21 ([changelog](../changelogs/2026-08-21-github-webhook.md)); Stage A CLI verbs shipped earlier. |
