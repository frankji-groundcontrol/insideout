...
| P1 | [Roadmap parity + GitHub-driven progress](2026-08-21-roadmap-parity-and-github.md) | **In flight** | Stage B: GitHub App (user-granted access), webhook endpoint, repo-side `insideout.yaml` matching guide. | Stage A live: agent build/expand + branch CRUD + sync as CLI verbs ([changelog](../changelogs/2026-08-21-roadmap-cli-parity.md)). |
