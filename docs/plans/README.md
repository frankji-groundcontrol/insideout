...
| P1 | [Restore Ink & Seal on Flutter](2026-08-19-restore-ink-seal.md) | **Completed** | Follow-on only: real-time multi-user presence on the canvas. | Fonts signed off 2026-08-20; canvas v1 (bands + minimap) 2026-08-22 ([changelog](../changelogs/2026-08-22-product-follow-ons.md)). |
...
| P1 | [CLI / MCP parity (one truth, many views)](2026-08-21-cli-mcp-parity.md) | **Completed** | None — Stage 3 closed 2026-08-22 (27 tools). | MCP server + agent vocabulary + all write verbs live ([depth](../changelogs/2026-08-22-depth-thread.md)). |
...
| P1 | [Nuxt → Flutter client](2026-08-17-flutter-client.md) (web + iOS + Android, full current surface) | **In flight** | Android release build — blocked: SDK verified absent 2026-08-22 (`flutter doctor`). | Hosted walk 2026-08-18. Nuxt `app/` deleted. |
| P1 | [Frontier: audience view, proposal application, cursors](2026-08-22-frontier.md) | **Completed** | None — closed 2026-08-22. | Audience web view, structured proposals applied on accept, live cursors ([changelog](../changelogs/2026-08-22-frontier.md)). |
| P1 | [Depth thread: presence + time-first roadmap](2026-08-22-depth-thread.md) | **Completed** | None — closed 2026-08-22. | Live presence (SSE) + deadlines/pressure/Progress view ([changelog](../changelogs/2026-08-22-depth-thread.md)). |
