...
| P1 | [CLI / MCP parity (one truth, many views)](2026-08-21-cli-mcp-parity.md) | **In flight** | Stage 3: write verbs + agent vocabulary, projected to CLI and MCP together. | MCP server live with 14 tools 1:1 ([changelog](../changelogs/2026-08-21-guide-and-mcp.md)). |
| P1 | [Roadmap parity + GitHub-driven progress](2026-08-21-roadmap-parity-and-github.md) | **In flight** | Install the GitHub App (user); build guide loader + installation tokens. | Webhook + guide scaffolding live ([webhook](../changelogs/2026-08-21-github-webhook.md), [guide+MCP](../changelogs/2026-08-21-guide-and-mcp.md)). |
