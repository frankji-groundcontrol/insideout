...
| P1 | [CLI / MCP parity (one truth, many views)](2026-08-21-cli-mcp-parity.md) | **In flight** | Stage 2: MCP server with tools 1:1 to the CLI verbs. | CLI read surface live and verified against the hosted API ([changelog](../changelogs/2026-08-21-cli-read-parity.md)). |
